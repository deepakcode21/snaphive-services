        ...
        {aToken && (
          <ul className="mt-16 text-[#515151]">
            {[
              ...
              { to: "/all-bookings", icon: assets.booking_icon, text: "Bookings" },
              { to: "/add-professional", icon: assets.add_icon, text: "Add Professional" },
              { to: "/pro-list", icon: assets.people_icon, text: "Professional List" },
            ].map((item) => (
              <NavLink
                key={item.to}
                className={({ isActive }) =>
