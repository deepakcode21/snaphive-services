...
const Banner = () => {
  ...
  return (
    <div className="relative flex flex-col md:flex-row bg--500 rounded-2xl bg-white px-6 md:px-10 lg:px-12 shadow-[11px_10px_0px_rgba(0,0,0,0.85)] border-[1px] border-black my-10 mx-4 md:mx-10 max-w-screen-xl lg:mx-auto">
      {/* Decorative Element */}
      ...
      <div className="flex-1 flex flex-col items-start justify-center gap-4 py-8 md:py-10 lg:py-12">
        <div className="text-4xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-gray-900">
          ...
          <p className=" text-3xl mt-2 text-gray-700 sm:mt-4">With 100+ Trusted Professionals</p>
        </div>
        <button
          onClick={() => {
            navigate("/login");
